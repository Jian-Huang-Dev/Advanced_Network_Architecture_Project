...
net.addLink(s1, s2, bw = 99.2)
net.addLink(s2, s5, bw = 99.2)
net.addLink(s2, s6, bw = 24.8)
net.addLink(s2, s12, bw = 99.2)
net.addLink(s9, s12, bw = 99.2)
net.addLink(s9, s3, bw = 99.2)
net.addLink(s3, s6, bw = 99.2)
net.addLink(s6, s7, bw = 99.2)
net.addLink(s7, s4, bw = 99.2)
net.addLink(s4, s11, bw = 99.2)
net.addLink(s11, s10, bw = 99.2)
net.addLink(s10, s8, bw = 99.2)
net.addLink(s8, s5, bw = 99.2)
net.addLink(s7, s5, bw = 99.2)
net.addLink(s4, s10, bw = 99.2)
...
# Start
net.addController('controller', controller=RemoteController,ip='127.0.0.1',port=6636)
net.build()
net.start()
